...
test('Administracion de Instituciones - Agregar Entidad', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Institución', exact: true }).click();
  await page.getByRole('textbox', { name: 'Institución', exact: true }).fill('QQ');
  await page.getByRole('textbox', { name: 'Sigla' }).click();
  await page.getByRole('textbox', { name: 'Institución', exact: true }).click();
  await page.getByRole('textbox', { name: 'Institución', exact: true }).fill('QQAAAA');
  await page.getByRole('textbox', { name: 'Sigla' }).click();
  await page.getByRole('textbox', { name: 'Sigla' }).fill('QQA');
  await page.getByRole('textbox', { name: 'Persona de contacto', exact: true }).click();
  await page.getByRole('textbox', { name: 'Persona de contacto', exact: true }).fill('JHON');
  await page.getByRole('textbox', { name: 'Teléfono de la persona de' }).click();
  await page.getByRole('textbox', { name: 'Teléfono de la persona de' }).fill('123123213');
  await page.getByRole('textbox', { name: 'Dirección' }).click();
  await page.getByRole('textbox', { name: 'Dirección' }).fill('Ceja');
  await page.getByRole('textbox', { name: 'Teléfono de la institución' }).click();
  await page.getByRole('textbox', { name: 'Teléfono de la institución' }).fill('123123123');
  await page.getByRole('textbox', { name: 'Correo electrónico' }).click();
  await page.getByRole('textbox', { name: 'Correo electrónico' }).fill('asdasd@daasdasd');
